...
Help:
     ...
     --download <input_path>       Download video                -d
         ...
         --cookies <cookies>       Cookies used to download
             <cookies>
         --header, H <header>      HTTP Header used to download
             <header>              Custom header. eg. "User-Agent: xxxxx". This option will override --cookies.
         --live                    Download live
...
A: By providing multiple -H/--header option. For example, `minyami -d xxxx -H "Cookie: xxxx" --header "User-Agent: yyy"`.
